...
In Customer Identity and Access Management (CIAM), the \"callback\" serves many purposes, and each of them are vital to understanding the layers of trust that forms modern authoriztion.  At each layer of these callbacks we see different methods of security(mTLS, JWT, PKCE) packed into different tokens in different ways. 
